...
class FileComparatorTest {
  ...
  void compare_pixivTypeSameBaseName_returnComparedToNumber(String file1, String file2,
      int expected) {
    FileComparator fileComparator = new FileComparator();
  ...
  void compare_pixivTypeNonEqualBaseName_returnComparedToBaseName(String arg1, String arg2,
      int expected) {
    FileComparator fileComparator = new FileComparator();
    File file = new File(arg1);
    File file1 = new File(arg2);
